...
WinePrompt = The installer detected that the setup have been launched through Wine. You don't need to install any of the redistributable components - instead, install vcrun2019 into the game prefix via winetricks. 